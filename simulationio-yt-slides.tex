...
\mode<presentation>
% Time-stamp: <2016-05-19 23:11:50 (jmiller)>
...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \draw (4,8) node[mynode] (rdiscretization) {Discretization};
    \draw (4,5) node[mynode] (discretization1) {Discretization};
    \draw (4,2) node[mynode] (discretization2) {Discretization};
